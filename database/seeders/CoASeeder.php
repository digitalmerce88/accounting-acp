...
class CoASeeder extends Seeder {
    public function run(): void {
        ...
        $accs = [
            ...
            ['159','ค่าเสื่อมสะสม','asset','credit'],
            ...
            ['480','กำไรจากการจำหน่ายทรัพย์สิน','revenue','credit'],
            ['501','ต้นทุนขาย','expense','debit'],
            ['502','ค่าใช้จ่ายทั่วไป','expense','debit'],
            ['503','ค่าเสื่อมราคา','expense','debit'],
            ['530','ขาดทุนจากการจำหน่ายทรัพย์สิน','expense','debit'],
            ['561','กำไรจากอัตราแลกเปลี่ยน','revenue','credit'],
            ['751','ขาดทุนจากอัตราแลกเปลี่ยน','expense','debit'],
