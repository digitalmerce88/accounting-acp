<template>
  <AdminLayout>
    <h1 class="text-xl font-semibold mb-4">เพิ่มหมวดหมู่ทรัพย์สิน</h1>
...
const form = reactive({ name:'', useful_life_months:12, depreciation_method:'slm' })
const processing = ref(false)
function submit(){
  processing.value = true
  router.post('/admin/assets/categories', form, { onFinish(){ processing.value=false } })
}
</script>
