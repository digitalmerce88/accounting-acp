...
<body>
  ...
  <table>
    <tr>
      ...
      <td class="right" style="width: 120px;">{{ number_format($bill->subtotal,2) }}</td>
    </tr>
    <tr>
      <td class="right">VAT</td>
      <td class="right">{{ number_format($bill->vat_decimal,2) }}</td>
    </tr>
    <tr>
      <td class="right"><strong>Total</strong></td>
      <td class="right"><strong>{{ number_format($bill->total,2) }}</strong></td>
    </tr>
  </table>
</body>
</html>
